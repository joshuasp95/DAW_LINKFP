...
public class Ejercicio01 {//Clase que contiene el codigo principal
    ...
    public static void main(String[] args) {//funcion que va a ejecutar el programa
        ...
        if (!carpeta_jsp.exists()) {
            ...
            System.out.println("El directorio: "+carpeta_jsp.getName()+"; con ruta: "+carpeta_jsp.getPath()+" ya estaba recogido en memoria");
        }
        ...
        try {
            if (!archivo_jsp.exists()) {
                archivo_jsp.createNewFile();//funcion para crear archivo (metodo dentro del objeto archivo)
            }
            else{
                System.out.println("El archivo: "+archivo_jsp.getName()+"; con ruta: "+archivo_jsp.getPath()+" ya estaba recogido en memoria");
            }
            if (!archivo2_jsp.exists()) {
                archivo2_jsp.createNewFile();
            }
            else{
                System.out.println("El archivo: "+archivo2_jsp.getName()+"; con ruta: "+archivo2_jsp.getPath()+" ya estaba recogido en memoria");
            }
            System.out.println("");
